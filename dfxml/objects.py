...
class DiskImageObject(AbstractParentObject, AbstractChildObject, AbstractGeometricObject):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self._sha1: typing.Optional[str] = None
        self._sha224: typing.Optional[str] = None
        self._sha256: typing.Optional[str] = None
        self._sha384: typing.Optional[str] = None
        self._sha512: typing.Optional[str] = None
